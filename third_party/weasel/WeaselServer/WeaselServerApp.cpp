...
void show_lang_picker(HWND /*hwnd*/) {
  ...
  ps += L"语种名（直接翻译为该语言）：`n";
  ps += L"   English / 日本語 / 한국어 / Français / Deutsch / Español / 粵語`n`n";
  ps += L"风格化（指定语气/场景/年代）：`n";
  ps += L"   学术英语 / 商务日语 / 中二风格的日语 / 古汉语风格 / 网络流行语`n`n";
  ps += L"虚构语言或自定义描述（DeepSeek 自由发挥）：`n";
  ps += L"   Klingon battle prose / 火星文 / 像鲁迅一样的英语\";";
